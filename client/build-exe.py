...
args = f"./client/main.py -Fw{strip} -n generator " + \
    f"--add-data {joinpath('.', 'client', 'res', 'design.ui')}{delim}res " + \
    f"--add-data {joinpath('.', 'client', 'res', 'Gear.jpg')}{delim}res " + \
    f"--add-data {joinpath('.', 'client', 'res', f'kmit.{iconext}')}{delim}res " \
